...
const AdoptionCard: React.FC<AdoptionCardProps> = ({ id, name, img, gender, age, desc1, desc2, url, breed, funds }) => {
    ...
    return (
        <>
            ...
            {showModal && (
                    <AdoptionCardModal id={id} name={name} img={img} gender={gender} age={age} desc1={desc1} desc2={desc2} url={url} breed={breed} funds={funds} setShowModal={setShowModal}/>
            )}
        </>
